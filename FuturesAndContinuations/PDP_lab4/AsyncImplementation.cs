...
namespace PDP_lab4
{
    public class AsyncImplementation
    {
        ...
        private static async void StartDownload(int id, string host)
        {
        ...
        private static async Task Connect(State state)
        {
            ...
            await Task.FromResult(state.connectEvent.WaitOne());
        }
        ...
        private static async Task Send(State state)
        {
            ...
            await Task.FromResult(state.sendEvent.WaitOne());
        }
        ...
        private static async Task Receive(State state)
        {
            ...
            await Task.FromResult(state.receiveEvent.WaitOne());
        }
